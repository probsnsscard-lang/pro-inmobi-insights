...
export function generatePDF(
  ...
  // ── Block 2b: VALOR COMERCIAL ESTIMADO (moved to top priority) ──
  doc.setFontSize(12);
  doc.setFont('helvetica', 'bold');
  doc.setTextColor(...navyDark);
  doc.text(isTerrain ? '■ VALOR COMERCIAL ESTIMADO (Basado en Corazón de Mercado)' : '■ VALOR COMERCIAL ESTIMADO (Basado en Corazón de Mercado)', marginL, y);
  y += 6;
